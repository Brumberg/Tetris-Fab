...
public class WarehouseActivity extends AppCompatActivity {
    ...
    private BlockDescriptor BockDescription[][] = { //descriptor list
            ...
            {       new BlockDescriptor(R.id.ID_WarehouseMode_S_Black_Counter_Button,BlockShape.FOUR_SHAPE,BlockColor.BLACK),
                    new BlockDescriptor(R.id.ID_WarehouseMode_S_Red_Counter_Button,BlockShape.FOUR_SHAPE,BlockColor.RED),
                    new BlockDescriptor(R.id.ID_WarehouseMode_S_Green_Counter_Button,BlockShape.FOUR_SHAPE,BlockColor.GREEN),
                    new BlockDescriptor(R.id.ID_WarehouseMode_S_Blue_Counter_Button,BlockShape.FOUR_SHAPE,BlockColor.BLUE),
                    new BlockDescriptor(R.id.ID_WarehouseMode_S_Yellow_Counter_Button,BlockShape.FOUR_SHAPE,BlockColor.YELLOW),
            },
            {
                    new BlockDescriptor(R.id.ID_WarehouseMode_T_Black_Counter_Button,BlockShape.MIRRORED_T_SHAPE,BlockColor.BLACK),
                    new BlockDescriptor(R.id.ID_WarehouseMode_T_Red_Counter_Button,BlockShape.MIRRORED_T_SHAPE,BlockColor.RED),
                    new BlockDescriptor(R.id.ID_WarehouseMode_T_Green_Counter_Button,BlockShape.MIRRORED_T_SHAPE,BlockColor.GREEN),
                    new BlockDescriptor(R.id.ID_WarehouseMode_T_Blue_Counter_Button,BlockShape.MIRRORED_T_SHAPE,BlockColor.BLUE),
                    new BlockDescriptor(R.id.ID_WarehouseMode_T_Yellow_Counter_Button,BlockShape.MIRRORED_T_SHAPE,BlockColor.YELLOW),
            },
            {
                    new BlockDescriptor(R.id.ID_WarehouseMode_L_Black_Counter_Button,BlockShape.L_SHAPE,BlockColor.BLACK),
                    new BlockDescriptor(R.id.ID_WarehouseMode_L_Red_Counter_Button,BlockShape.L_SHAPE,BlockColor.RED),
                    new BlockDescriptor(R.id.ID_WarehouseMode_L_Green_Counter_Button,BlockShape.L_SHAPE,BlockColor.GREEN),
                    new BlockDescriptor(R.id.ID_WarehouseMode_L_Blue_Counter_Button,BlockShape.L_SHAPE,BlockColor.BLUE),
                    new BlockDescriptor(R.id.ID_WarehouseMode_L_Yellow_Counter_Button,BlockShape.L_SHAPE,BlockColor.YELLOW),
            },
            {
