...
import static com.example.crunky.testapp.R.id.*;

public class SelectFactoryActivity extends AppCompatActivity {

    private Button bScan;
    private ProgressBar pbScanProgress;
    private BlockFactoryManagement m_factoryManagement;
    private BlockFactory m_currentFactory;
    private ListView lvFactories;
    private BlockFactoryListAdapter m_adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m_factoryManagement = new BlockFactoryManagement((Context) (this));
    ...
    private void factoryManagement_onStartScanning(BlockFactoryManagement sender) {
    ...
    private void factoryManagement_onIpScanned(BlockFactoryManagement sender) {
        pbScanProgress.setProgress(sender.getScannedIps());
    }

    private void factoryManagement_onAllIpsScanned(BlockFactoryManagement sender) {
        bScan.setVisibility(View.VISIBLE);
        pbScanProgress.setVisibility(View.INVISIBLE);
        m_adapter=new BlockFactoryListAdapter(this, m_factoryManagement.getBlockFactories());
    ...
    private void lvFactories_onItemClick(View view) {
        m_currentFactory=(BlockFactory)(lvFactories.getSelectedItem());
        if(m_currentFactory!=null) {
